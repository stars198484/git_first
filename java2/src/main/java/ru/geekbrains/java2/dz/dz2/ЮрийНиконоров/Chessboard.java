...
public class Chessboard {
    ...
    public Chessboard() {
        ...
        pawns[0] = new Pawn(0,3,true);
        chessboard[3][0].setFigureInCell(pawns[0]);

        pawns[8] = new Pawn(1,4,false);
        chessboard[4][1].setFigureInCell(pawns[8]);
    ...
    public String getNameFigure(int x, int y) throws UnspecifiedFigure {
        if (chessboard[y][x].getFigureInCell()!=null) return chessboard[y][x].getFigureInCell().getName();
        else throw new UnspecifiedFigure();
    }
