...
public class GameField {
    ...
    public boolean strike(int cx, int cy) { //true если есть попадание
        ...
        return true; //попал или уже ходил сюда
    }
    ...
    public boolean isStriked(int cx, int cy){
     if (fl[cy][cx] == MISS) return true;
     return false;
    }
}
